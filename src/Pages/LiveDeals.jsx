...
const values = [
  {
    ...
    logoName: "",
    logoText: "CCD",
    heading: "MildCares - GynoCup",
    subHeading:
      "This is not the actual text for this section of this card, something else will come here",
    description:
      "We at Mildcares strive to empower womanhood! By building high-quality hygiene and personal care products our…",
    chip: [
      { id: 1, name: "health" },
      { id: 2, name: "Personal Health" },
    ],
    Completed: "14.16%",
    closesIn: "10 days",
    invest: "₹5,000",
  ...
  },
  {
    ...
    logoText: "CSOP",
    heading: "",
    subHeading: "This is not the actual text for this section",
    description:
  ...
  },
  {
    ...
    subHeading:
      "This is not the actual text for this section of this card, something else will come here",
    description:
      "Diversify your portfolio with Agri-Subscriptions & Earn Tax-free fixed income Diversify your portfolio",
      ...
      <div style={{ display: "flex", position: "relative" }}>
        ...
        >
          <Container className="live-opportunities-container" maxWidth="lg">
            ...
            {/* CSOP */}
            {userData?.user_type &&
              superArray?.map((item, index) => (
                <div id={`tab-${item.id}`} key={index}>
                  <span style={{ fontSize: "20px", fontWeight: "600" }}>
                    {item.deal_type}
                    <LightTooltip
                      placement="top"
                      popperOptions={{ popperOptions }}
                      title="Community Subscription Offer Plan is a contractual agreement executed between a subscriber and the startup that entitles the subscriber to community benefits and grant of SAR in exchange"
                    >
                      <img
                        style={{
                          marginBottom: "-2.5px",
                  ...
                  <div style={{ display: "grid", marginTop: "0.5rem" }}>
                    <span style={{ fontSize: "18px" }}>
                      Subscribe to rapidly growing companies with a low minimum
                      Subscription requirement.
                    </span>
                  </div>
                  <Grid
                    className="live-opportunities-grid"
                    sx={{
                      marginTop: "30px",
                      gap: "20px",
                      marginBottom: "5rem",
                  ...
                  >
                    {item.campaigns?.map((campaign, index) => {
                      return (
                        ...
                        >
                          <CardContent
                            className="live-opportunities-card-content"
                            sx={{ padding: "0", width: "300px" }}
                          >
                            <div style={{ position: "relative" }}>
                              ...
                              <div className="bottom-txt-card">
                                <span>
                                  {campaign?.campaign_id?.company_id?.product_description.slice(
                                    0,
                                    80
                                  )}
                                </span>
                            ...
                            <div className="body-card-section">
                              <span className="card-description">
                                {`${campaign?.campaign_id?.company_id?.traction_description.slice(
                                  0,
                                  100
                                )}...`}
                              </span>
                              <div style={{ display: "flex" }}>
                                <div key={index} className="chip-status">
                                  <span>health</span>
                                </div>
                              </div>
                            ...
                            <div className="overlay">
                              ...
                              >
                                <span className="investment-txt hover">
                                  Enroller
                                </span>
                                <span className="investment-sub-txt hover">
                                  0
                                </span>
                                ...
                                <div className="chip-status hover">
                            ...
                            <div
                              ...
                              className="mobile-view-arrow-responsive"
                            >
                              <KeyboardArrowDownRoundedIcon
                                className="move-arrow-upside-down"
                                style={
                                  item.checked
            ...
            {!userData?.user_type && (
              <Grid
                className="investor-home-deal-card"
                sx={{
                  marginTop: "5px",
                  gap: "20px",
                  width: "100%",
                ...
                >
                  <CardContent sx={{ padding: "0", width: "300px" }}>
                    <div style={{ position: "relative" }}>
                      ...
                      <div className="card-header-logo">
                        <div className="company-logo-section">
                          <img loading="lazy" src={""} height={44} />
                        </div>
                        <div className="logo-txt-script">deal type</div>
                      </div>
                      <div className="info-card-txt">
                        {/* <span className="company-name">{item.deal_type}
                                                                </span> */}
                    ...
                    100
                      ...
                      <div className="footer-card-section">
                        ...
                        <div className="vertical-line-invest"></div>
                        <div className="numbers-investors">
                          <span className="percentage-investment">0 days</span>
