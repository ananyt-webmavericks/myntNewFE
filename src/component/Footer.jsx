    ...
    <div className="footer-container">
        ...
        <Grid item xs={gridxsFirst}>
          <div className="footer-head-section">
            ...
            <span className="footer-text-header">
              Mynt is a transparency and technology-focused alternate enrollment
              platform that adds value to your wealth creation goals by making
              the best Startup opportunities accessible across the entire
          ...
          <div className="all-link-section">
            ...
            <div className="contact-us-at">
              <div className="investor-university-section-second">
                ...
                <span className="Detail-link">246, Phase IV, Udyog Vihar</span>
      ...
      <div className="footer-bottom-section">
        ...
        <span className="footer-text-header">
          ...
          regulated exchange. All trademarks and logos or registered trademarks
          and logos found on this site or mentioned herein belong to their
          respective owners, and are being used solely for informational
          purposes. The information contained herein has been collected from
          public sources, MXi Technologies Pvt Ltd disclaims any and all
          responsibility in connection with veracity of this data. The
          information on this website is intended solely for educational
          purposes and should not be considered as legal, financial, or any
          other type of advice. MXi Technologies Pvt Ltd holds no liability for
          any financial or other losses suffered by the user or any affiliated
          party based on the information provided here. In addition, MXi
          Technologies Pvt Ltd does not facilitate any buying, selling, or
          trading of securities either online or offline. This Site will be
