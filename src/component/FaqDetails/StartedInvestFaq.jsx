...
const data = [
    {id:1 , head:"What is the meaning of early-stage or startup investments?" , content:"Investing in startups that are still building a revenue model, growing their customer base and scaling rapidly will qualify as early-stage startup investments. These startups have a huge growth potential and provide an opportunity to earn handsome returns. The Thomson Reuters Venture Capital Research Index replicated the performance of venture capital industry in 2015 and found that overall venture capital has returned an annual rate of 20.6% since 1996 – far outperforming modest returns of 7.5% and 5.9% from public equities and bonds respectively. "},    
    ...
    {id:7 , head:"What is an Alternative Investment Fund (AIF)?" , content:"AIFs are pooled investment vehicles that invest in private equity, venture capital or private debt. It can be established in the form of a body corporate, a trust or an LLP.As per SEBI, this is the only vehicle permissible in case funds from multiple investors are to be pooled for the purpose of investment in an entity, i.e. the pooled funds will appear as only one line on the cap table. "},  
    {id:8 , head:"Who can invest in an AIF?" , content:"As per SEBI regulations, an investor has to satisfy the following criteria to invest in an AIF: i. Minimum investment of INR 1 crores (INR 25 lakhs for directors, employees or fund managers of if the person is investing in an Angel Fund) ii. Minimum lock-in period of 3 years iii. Number of investors is restricted to 1,000 in a scheme (except Angel Funds in which the number is restricted to 49) "},  
    {id:9 , head:"Does Tyke route investments via an AIF?" , content:"No, all investments on our platform are direct investments in the startup and are not routed via an AIF. However, we have partnered with an AIF in case a founder wants to facilitate a private fund raise with own identified list of investors. These opportunities will not be visible on the platform."},  
]
