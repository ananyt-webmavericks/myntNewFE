...
const data = [
    ...
    {id:8 , head:"Who can invest in an AIF?" , content:"As per SEBI regulations, an investor has to satisfy the following criteria to invest in an AIF: i. Minimum Subscription of INR 1 crores (INR 25 lakhs for directors, employees or fund managers of if the person is investing in an Angel Fund) ii. Minimum lock-in period of 3 years iii. Number of investors is restricted to 1,000 in a scheme (except Angel Funds in which the number is restricted to 49) "},  
