...
const data = [
    ...
    { id: 5, head: "How are CSOPs taxed?", content: "Subscription amount towards CSOP will be categorized as an expense.At the time of repayments, income from CSOP exit shall be taxed under the head 'Income from Other Sources'. The entire amount received shall be taxed as per the subscriber's income tax slab. " },
