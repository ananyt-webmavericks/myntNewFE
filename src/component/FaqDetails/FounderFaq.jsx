...
const data = [
    ...
    {id:5 , head:'For what types of instruments can I run a campaign on Tykeinvest?' , content:'On Tykeinvest, you can choose to do a CSOP campaign, a CCD campaign, a CCPS campaign or an NCD campaign'},
