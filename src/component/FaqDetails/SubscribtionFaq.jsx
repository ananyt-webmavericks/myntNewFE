...
const data = [
    ...
    {id:11, head:"What is the minimum Subscription required to subscribe to a CCD or CCPS?" , content:"There is no threshold value. The minimum subscription to a CCD or CCSP campaign is determined by the company raising funds with inputs from us based on our experience. "},
