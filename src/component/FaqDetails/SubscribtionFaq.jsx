...
const data = [
    { id: 1, head: "What's next after the payment? When will i receive my instrument?", content: "Once the startup completes its campaign successfully, we'll work with the startup to get your SAR agreement/T-SAFE ready to be signed. A SAR/T-SAFE agreement governs the legality behind your subscription in the corresponding startup. This SAR agreement/T-SAFE will be available on your dashboard. For T-SAFE, the formalities for filing documents with MCA will start. The offer letter will be uploaded and be accessible from the portfolio section. " },
    ...
    { id: 4, head: "What is the proof I will receive for my subscription?", content: "Documents will depend on the type of subscription: 1.For SAR: SAR agreement and SAR Letter. 2. For CCD/CCPS/NCD: Subscription agreement and Offer Letter 3. For Discounting: An acknowledgement email" },
    ...
    { id: 11, head: "What is the minimum Enrollment required to subscribe to a CCD or CCPS?", content: "There is no threshold value. The minimum Enrollment to a CCD or CCSP campaign is determined by the company raising funds with inputs from us based on our experience. " },
