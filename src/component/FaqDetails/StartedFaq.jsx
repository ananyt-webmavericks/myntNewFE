...
const data = [
    ...
    { id: 3, head: 'What is minimum Enrollment amount?  ', content: "To provide you with flexibility in choosing an subscription amount, we aim to keep the minimum Enrollment amount as low as possible. Tyke’s platform-wide minimum is INR 5,000 for SARs (Community Subscription Offer Plan)For CCDs, CCPS and NCD, the minimum Enrollment as per SEBI guidelines is INR 20,000. Subscriptions can be done in multiples of Rs. 1,000 beyond the minimum threshold. " },
