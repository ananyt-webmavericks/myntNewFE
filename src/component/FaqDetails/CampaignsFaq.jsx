...
const data = [
    ...
    { id: 12, head: 'Do all instruments come on the cap table?', content: 'No. SAR, CCD and NCD do not come on the cap table. Equity shares issued as a result of conversion of CCD will come on the cap table.' },
