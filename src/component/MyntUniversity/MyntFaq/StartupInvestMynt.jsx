                                ...
                                <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')} style={{ boxShadow: ' 0px 0px 10px #0000000D', border: '1px solid #D1D1D1' }}>
                                    ...
                                    <AccordionDetails>
                                        <Typography>
                                            ...
                                            -  The minimum Enrollment limit is Rs. 1 crore for investors, whereas the minimum Enrollment amount for directors, employees, and fund managers are Rs. 25 lakh.  <br />
