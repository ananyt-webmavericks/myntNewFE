                            ...
                            <div style={{ marginTop: '30px' }}>
                                ...
                                <div style={{ marginTop: '30px' }}>
                                    <Accordion expanded={expanded === 'panel6'} onChange={handleChange('panel6')} style={{ boxShadow: ' 0px 0px 10px #0000000D', border: '1px solid #D1D1D1' }}>
                                        ...
                                        <AccordionDetails>
                                            <Typography>
                                            A CSOP is a contract that the founder and an enroller have signed. The agreement grants the enroller rights to receive SAR (stock appreciation rights) and entitlement to other benefits. 
                                            </Typography>
                                        </AccordionDetails>
                                    </Accordion>
                                </div>
                                <div style={{ marginTop: '30px' }}>
                                    <Accordion expanded={expanded === 'panel7'} onChange={handleChange('panel7')} style={{ boxShadow: ' 0px 0px 10px #0000000D', border: '1px solid #D1D1D1' }}>
                                        ...
                                        >
                                            <div>
                                                <span style={{ fontWeight: 600, fontSize: '16px' }}> 
                                                What are the benefits of enrolling in CSOP?
                                                </span>
                                            </div>
                                        </AccordionSummary>
                                        <AccordionDetails>
                                ...
                                <div style={{ marginTop: '30px' }}>
                                    <Accordion expanded={expanded === 'panel8'} onChange={handleChange('panel8')} style={{ boxShadow: ' 0px 0px 10px #0000000D', border: '1px solid #D1D1D1' }}>
                                        ...
                                        <AccordionDetails>
                                            <Typography>
                                            The grant of Stock Appreciation Rights (SARs) of the company is attained by enrollment to a CSOP. Similar to ESOPs, SARs give the grantee the right to receive money equal to growth in the market value of the company's equity shares. However, no equity shares are issued in this transaction.
                                            </Typography>
                                        </AccordionDetails>
                                    </Accordion>
                                </div>
