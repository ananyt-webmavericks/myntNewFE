...
export default function HowToRaise() {
    ...
    return (
        <div style={{textAlign:'center'}} className="how-to-raise-container">
            ...
            <div className="hide-scroll" style={{ height: 950,justifyContent:'space-evenly',textAlign:'start',overflow: 'hidden', overflowX: 'scroll', display: 'flex', alignItems: 'center' }}>
