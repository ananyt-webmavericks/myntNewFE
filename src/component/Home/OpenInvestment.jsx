    ...
    <>
      <Box sx={{ minHeight: "80vh", marginTop: "60px", marginBottom: "2em" }}>
        <div className="subscribe-graph-heading">
          <Typography className="test-script-regular">
            <span style={{ color: "black" }} className="test-script-bg">
              LIVE
            </span>
          </Typography>
          <Typography style={{ fontSize: "18px", color: "gray" }}>
            Get access to highly vetted opportunities
          </Typography>
        </div>
       {userData?.user_type && <Grid
          className="investor-home-deal-card"
          sx={{ marginTop: "5px", gap: "20px", width: "100%", marginLeft: 0 }}
          container
          spacing={spaceing}
        >
                  ...
                  <div style={{ position: "relative" }}>
                    ...
                    <div className="card-header-logo">
                      <div className="company-logo-section">
                        <img
                          loading="lazy"
                          src={campaign?.campaign_id?.company_id?.company_logo}
                          height={44}
                        />
                      </div>
       ...
       {!userData?.user_type && <Grid
        ...
        {showBtn && (
          <div className="view-all-btn-invest">
            <Button
              variant="contained"
              className="invest-load-btn"
