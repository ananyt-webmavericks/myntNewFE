                    ...
                    <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')} style={{ boxShadow: 'none', border: '1px solid #D1D1D1' }}>
                        ...
                        >
                            <div>
                                ...
                                <span style={{ fontWeight: 600, fontSize: '16px' }}> What is Startup Investing? </span>
                            </div>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Typography>
                    ...
                    <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')} style={{ boxShadow: 'none', border: '1px solid #D1D1D1' }}>
                        ...
                        >
                            <div>
                                ...
                                <span style={{ fontWeight: 600, fontSize: '16px' }}>  Why should you Invest in Startups?</span>
                            </div>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Typography>
                    ...
                    <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')} style={{ boxShadow: 'none', border: '1px solid #D1D1D1' }}>
                        ...
                        >
                            <div>
                                ...
                                <span style={{ fontWeight: 600, fontSize: '16px' }}> What are the instrument types typically used in fund-raising?</span>
                            </div>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Typography>
                    ...
                    <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')} style={{ boxShadow: 'none', border: '1px solid #D1D1D1' }}>
                        ...
                        >
                            <div>
                                ...
                                <span style={{ fontWeight: 600, fontSize: '16px' }}> What are the risks involved in investing in startup equity?</span>
                            </div>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Typography>
